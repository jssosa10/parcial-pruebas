...
final class VorbisUtil {
    ...
    public static VorbisIdHeader readVorbisIdentificationHeader(ParsableByteArray headerData) throws ParserException {
        ...
        int i = blockSize0;
        int i2 = blockSize;
        VorbisIdHeader vorbisIdHeader = new VorbisIdHeader(version, channels, sampleRate, bitrateMax, bitrateNominal, bitrateMin, blockSize0, (int) Math.pow(2.0d, (double) ((blockSize & PsExtractor.VIDEO_STREAM_MASK) >> 4)), (headerData.readUnsignedByte() & 1) > 0, Arrays.copyOf(parsableByteArray.data, headerData.limit()));
    ...
    private static CodeBook readBook(VorbisBitArray bitArray) throws ParserException {
        ...
        if (bitArray.readBits(24) == 5653314) {
            ...
            if (lookupType <= 2) {
                ...
                CodeBook codeBook = new CodeBook(dimensions, entries, lengthMap, lookupType, isOrdered);
                return codeBook;
            }
            StringBuilder sb = new StringBuilder();
        ...
        sb2.append(bitArray.getPosition());
        throw new ParserException(sb2.toString());
    }
