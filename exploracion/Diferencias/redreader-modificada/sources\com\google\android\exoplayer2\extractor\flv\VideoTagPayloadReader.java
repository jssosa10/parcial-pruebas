...
final class VideoTagPayloadReader extends TagPayloadReader {
    ...
    public void parsePayload(ParsableByteArray data, long timeUs) throws ParserException {
        ...
        if (packetType == 0 && !this.hasOutputFormat) {
            ...
            int i = avcConfig.width;
            int i2 = avcConfig.height;
            this.output.format(Format.createVideoSampleFormat(null, str, null, -1, -1, i, i2, -1.0f, avcConfig.initializationData, -1, avcConfig.pixelWidthAspectRatio, null));
            ...
            trackOutput.sampleMetadata(timeUs2, i3, bytesWritten, 0, null);
        }
    }
}
