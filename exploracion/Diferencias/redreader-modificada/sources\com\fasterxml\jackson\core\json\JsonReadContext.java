...
public final class JsonReadContext extends JsonStreamContext {
    ...
    public static JsonReadContext createRootContext(int lineNr, int colNr, DupDetector dups) {
        JsonReadContext jsonReadContext = new JsonReadContext(null, dups, 0, lineNr, colNr);
    ...
    public JsonReadContext createChildArrayContext(int lineNr, int colNr) {
        ...
        if (ctxt == null) {
            ...
            JsonReadContext jsonReadContext = new JsonReadContext(this, dupDetector, 1, lineNr, colNr);
    ...
    public JsonReadContext createChildObjectContext(int lineNr, int colNr) {
        ...
        if (ctxt == null) {
            ...
            JsonReadContext jsonReadContext = new JsonReadContext(this, dupDetector, 2, lineNr, colNr);
            JsonReadContext ctxt2 = jsonReadContext;
            this._child = jsonReadContext;
            return ctxt2;
        }
