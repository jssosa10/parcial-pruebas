...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements DeathRecipient {
        ...
        private static class StubCompat extends Stub {
            ...
            public void onVolumeInfoChanged(ParcelableVolumeInfo info2) throws RemoteException {
                Callback callback = (Callback) this.mCallback.get();
                if (callback != null) {
                    PlaybackInfo pi = null;
                    if (info2 != null) {
                        PlaybackInfo playbackInfo = new PlaybackInfo(info2.volumeType, info2.audioStream, info2.controlType, info2.maxVolume, info2.currentVolume);
                        pi = playbackInfo;
                    }
        ...
        public void onAudioInfoChanged(PlaybackInfo info2) {
        }
    ...
    static class MediaControllerImplBase implements MediaControllerImpl {
        ...
        public PlaybackInfo getPlaybackInfo() {
            try {
                ParcelableVolumeInfo info2 = this.mBinder.getVolumeAttributes();
                PlaybackInfo playbackInfo = new PlaybackInfo(info2.volumeType, info2.audioStream, info2.controlType, info2.maxVolume, info2.currentVolume);
                return playbackInfo;
            } catch (RemoteException e) {
