...
public final class H264Reader implements ElementaryStreamReader {
    ...
    private static final class SampleReader {
        ...
        private static final class SliceHeaderData {
            ...
            public boolean isFirstVclNalUnitOfPicture(SliceHeaderData other) {
                if (this.isComplete) {
                    ...
                    if (this.spsData.picOrderCountType == 1 && other.spsData.picOrderCountType == 1 && (this.deltaPicOrderCnt0 != other.deltaPicOrderCnt0 || this.deltaPicOrderCnt1 != other.deltaPicOrderCnt1)) {
                        return true;
                    }
                    boolean z = this.idrPicFlag;
                    boolean z2 = other.idrPicFlag;
                    if (z != z2) {
                        return true;
                    }
        ...
        public void endNalUnit(long position, int offset) {
            ...
            int i = this.nalUnitType;
            if (i == 5 || (this.allowNonIdrKeyframes && i == 1 && this.sliceHeader.isISlice())) {
                z = true;
            }
        ...
        private void outputSample(int offset) {
            int flags = (int) this.sampleIsKeyframe;
            this.output.sampleMetadata(this.sampleTimeUs, flags, (int) (this.nalUnitStartPosition - this.samplePosition), offset, null);
        }
    }
        ...
        if (!this.hasOutputFormat || this.sampleReader.needsSpsPps()) {
            ...
            if (!this.hasOutputFormat) {
                if (this.sps.isCompleted() && this.pps.isCompleted()) {
                    ...
                    SpsData spsData2 = spsData;
                    trackOutput2.format(Format.createVideoSampleFormat(str, str2, buildAvcCodecString, -1, -1, i2, i3, -1.0f, arrayList2, -1, f, null));
