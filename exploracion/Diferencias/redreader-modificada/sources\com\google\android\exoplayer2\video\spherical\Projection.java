...
public final class Projection {
    ...
    public static Projection createEquirectangular(float radius, int latitudes, int longitudes, float verticalFovDegrees, float horizontalFovDegrees, int stereoMode2) {
        ...
        float quadWidthRads = horizontalFovRads / ((float) i3);
        int vertexCount = (((i3 + 1) * 2) + 2) * i2;
        ...
        while (j < i2) {
            ...
            while (i4 < i3 + 1) {
                int k2 = 0;
                while (k2 < 2) {
                    float phi = k2 == 0 ? phiLow : phiHigh;
                    float theta = ((((float) i4) * quadWidthRads) + 3.1415927f) - (horizontalFovRads / 2.0f);
                    ...
                    textureData2[tOffset] = (((float) i4) * quadWidthRads) / horizontalFovRads;
                    int tOffset3 = tOffset2 + 1;
                    textureData2[tOffset2] = (((float) (j2 + k3)) * quadHeightRads) / verticalFovRads;
                    if (i4 == 0 && k3 == 0) {
                        k = k3;
                        i = longitudes;
                    } else {
                        ...
                        phiHigh = phiHigh2;
                        j = j2;
                        float f4 = verticalFovDegrees;
                        float f5 = horizontalFovDegrees;
                        i3 = i;
                        k2 = vOffset6;
                        f = radius;
                    }
                    ...
                    phiHigh = phiHigh2;
                    j = j2;
                    float f42 = verticalFovDegrees;
                    float f52 = horizontalFovDegrees;
                    i3 = i;
                    k2 = vOffset62;
                    f = radius;
                }
                float phiHigh3 = phiHigh;
                int i5 = k2;
                int k4 = i3;
                float[] fArr = textureData;
                i4++;
                phiHigh = phiHigh3;
                j = j;
                f = radius;
                float f6 = verticalFovDegrees;
                float f7 = horizontalFovDegrees;
                i3 = k4;
                int i6 = latitudes;
            }
            int i7 = i3;
