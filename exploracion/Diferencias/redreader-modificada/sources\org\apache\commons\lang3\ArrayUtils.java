...
public class ArrayUtils {
    ...
    public static <T> T[] addAll(T[] array1, T... array2) {
        ...
        try {
            ...
            if (!type1.isAssignableFrom(type2)) {
                ...
                throw new IllegalArgumentException(sb.toString(), ase);
            }
            throw ase;
        }
    }
    ...
    public static <T> T[] removeElements(T[] array, T... values) {
        ...
        for (int i = 0; i < array.length; i++) {
            T key = array[i];
            MutableInt count2 = (MutableInt) occurrences.get(key);
            if (count2 != null) {
    ...
    public static byte[] removeElements(byte[] array, byte... values) {
        ...
        for (int i = 0; i < array.length; i++) {
            byte key = array[i];
            MutableInt count2 = (MutableInt) occurrences.get(Byte.valueOf(key));
            if (count2 != null) {
                if (count2.decrementAndGet() == 0) {
    ...
    public static short[] removeElements(short[] array, short... values) {
        ...
        for (int i = 0; i < array.length; i++) {
            short key = array[i];
            MutableInt count2 = (MutableInt) occurrences.get(Short.valueOf(key));
            if (count2 != null) {
                if (count2.decrementAndGet() == 0) {
    ...
    public static int[] removeElements(int[] array, int... values) {
        ...
        for (int i = 0; i < array.length; i++) {
            int key = array[i];
            MutableInt count2 = (MutableInt) occurrences.get(Integer.valueOf(key));
            if (count2 != null) {
                if (count2.decrementAndGet() == 0) {
    ...
    public static char[] removeElements(char[] array, char... values) {
        ...
        for (int i = 0; i < array.length; i++) {
            char key = array[i];
            MutableInt count2 = (MutableInt) occurrences.get(Character.valueOf(key));
            if (count2 != null) {
                if (count2.decrementAndGet() == 0) {
    ...
    public static long[] removeElements(long[] array, long... values) {
        ...
        for (int i = 0; i < array.length; i++) {
            long key = array[i];
            MutableInt count2 = (MutableInt) occurrences.get(Long.valueOf(key));
            if (count2 != null) {
                if (count2.decrementAndGet() == 0) {
    ...
    public static float[] removeElements(float[] array, float... values) {
        ...
        for (int i = 0; i < array.length; i++) {
            float key = array[i];
            MutableInt count2 = (MutableInt) occurrences.get(Float.valueOf(key));
            if (count2 != null) {
                if (count2.decrementAndGet() == 0) {
    ...
    public static double[] removeElements(double[] array, double... values) {
        ...
        for (int i = 0; i < array.length; i++) {
            double key = array[i];
            MutableInt count2 = (MutableInt) occurrences.get(Double.valueOf(key));
            if (count2 != null) {
                if (count2.decrementAndGet() == 0) {
    ...
    public static boolean[] removeElements(boolean[] array, boolean... values) {
        ...
        for (int i = 0; i < array.length; i++) {
            boolean key = array[i];
            MutableInt count2 = (MutableInt) occurrences.get(Boolean.valueOf(key));
            if (count2 != null) {
                if (count2.decrementAndGet() == 0) {
