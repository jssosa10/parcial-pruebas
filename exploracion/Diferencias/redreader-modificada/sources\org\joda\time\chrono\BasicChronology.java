...
abstract class BasicChronology extends AssembledChronology {
    ...
    public static final DurationField cDaysField = new PreciseDurationField(DurationFieldType.days(), DateUtils.MILLIS_PER_DAY);
    ...
    public int getMillisOfDay(long j) {
        ...
        return ((int) ((j + 1) % DateUtils.MILLIS_PER_DAY)) + 86399999;
    }
