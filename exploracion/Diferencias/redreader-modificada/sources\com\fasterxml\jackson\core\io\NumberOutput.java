...
public final class NumberOutput {
    ...
    public static int outputInt(int v, byte[] b, int off) {
        ...
        if (v < MILLION) {
            if (v >= 1000) {
                int thousands2 = v / 1000;
                thousands = _full3(v - (thousands2 * 1000), b, _leading3(thousands2, b, off));
            } else if (v < 10) {
                thousands = off + 1;
                b[off] = (byte) (v + 48);
            } else {
        ...
        int off5 = v / 1000;
        int ones = v - (off5 * 1000);
        int v3 = off5;
        int newValue = off5 / 1000;
        return _full3(ones, b, _full3(v3 - (newValue * 1000), b, _leading3(newValue, b, off)));
    }
    ...
    private static int _outputFullBillion(int v, char[] b, int off) {
        ...
        b[off4] = (char) (enc2 >> 16);
        int off5 = enc3 + 1;
        b[enc3] = (char) ((enc2 >> 8) & 127);
        int off6 = off5 + 1;
        b[off5] = (char) (enc2 & 127);
        int enc4 = iArr[ones];
        int off7 = off6 + 1;
        b[off6] = (char) (enc4 >> 16);
        int off8 = off7 + 1;
        b[off7] = (char) ((enc4 >> 8) & 127);
        int off9 = off8 + 1;
        b[off8] = (char) (enc4 & 127);
        return off9;
    }
