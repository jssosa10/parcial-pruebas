...
final class Cea708Cue extends Cue implements Comparable<Cea708Cue> {
    ...
    public Cea708Cue(CharSequence text, Alignment textAlignment, float line, int lineType, int lineAnchor, float position, int positionAnchor, float size, boolean windowColorSet, int windowColor, int priority2) {
