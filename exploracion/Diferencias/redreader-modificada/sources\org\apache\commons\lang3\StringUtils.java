...
public class StringUtils {
    ...
    public static String[] substringsBetween(String str, String open, String close) {
        ...
        while (pos < strLen - closeLen) {
            ...
            int start2 = start + openLen;
            int end = str.indexOf(close, start2);
            if (end < 0) {
                break;
            }
    ...
    private static String replaceEach(String text, String[] searchList, String[] replacementList, boolean repeat, int timeToLive) {
        ...
        if (timeToLive >= 0) {
            ...
            if (searchLength == replacementLength) {
                ...
                for (int i2 = 0; i2 < strArr.length; i2++) {
                    if (!(strArr[i2] == null || strArr2[i2] == null)) {
                        int greater = strArr2[i2].length() - strArr[i2].length();
                        if (greater > 0) {
                            increase += greater * 3;
                        }
                    }
            ...
            sb.append(searchLength);
            sb.append(" vs ");
            sb.append(replacementLength);
    ...
    public static String repeat(String str, String separator, int repeat) {
        ...
        sb.append(str);
        sb.append(separator);
        return removeEnd(repeat(sb.toString(), repeat), separator);
    }
    ...
    public static String abbreviate(String str, String abbrevMarker, int offset, int maxWidth) {
        ...
        if (maxWidth < minAbbrevWidth) {
            ...
            if (offset <= abbrevMarkerLength + 1) {
                StringBuilder sb = new StringBuilder();
                sb.append(str.substring(0, maxWidth - abbrevMarkerLength));
                ...
                sb2.append(abbrevMarker);
                sb2.append(abbreviate(str.substring(offset), abbrevMarker, maxWidth - abbrevMarkerLength));
                return sb2.toString();
            } else {
                StringBuilder sb3 = new StringBuilder();
                sb3.append(abbrevMarker);
                sb3.append(str.substring(str.length() - (maxWidth - abbrevMarkerLength)));
                return sb3.toString();
            }
        }
    }
    ...
    public static String abbreviateMiddle(String str, String middle, int length) {
        ...
        sb.append(middle);
        sb.append(str.substring(endOffset));
        return sb.toString();
    }
    ...
    public static double getJaroWinklerDistance(CharSequence first, CharSequence second) {
        ...
        double d2 = d + (m / length2);
        double d3 = (double) mtp[1];
        Double.isNaN(m);
        Double.isNaN(d3);
        double d4 = m - d3;
        Double.isNaN(m);
        double j = (d2 + (d4 / m)) / 3.0d;
        if (j < 0.7d) {
            jw = j;
        } else {
            double d5 = (double) mtp[3];
            Double.isNaN(d5);
            double min = Math.min(0.1d, 1.0d / d5);
            double d6 = (double) mtp[2];
            Double.isNaN(d6);
            jw = (min * d6 * (1.0d - j)) + j;
        }
    ...
    public static String unwrap(String str, char wrapChar) {
        if (!isEmpty(str) && wrapChar != 0 && str.charAt(0) == wrapChar && str.charAt(str.length() - 1) == wrapChar) {
