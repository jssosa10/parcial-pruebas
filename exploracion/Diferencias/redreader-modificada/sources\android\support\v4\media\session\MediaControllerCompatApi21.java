...
class MediaControllerCompatApi21 {
    ...
    static class CallbackProxy<T extends Callback> extends android.media.session.MediaController.Callback {
        ...
        public void onAudioInfoChanged(android.media.session.MediaController.PlaybackInfo info2) {
            this.mCallback.onAudioInfoChanged(info2.getPlaybackType(), PlaybackInfo.getLegacyAudioStream(info2), info2.getVolumeControl(), info2.getMaxVolume(), info2.getCurrentVolume());
        }
    }
