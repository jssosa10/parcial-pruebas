...
final class ProjectionRenderer {
    ...
    /* access modifiers changed from: 0000 */
    public void draw(int textureId, float[] mvpMatrix, int eyeType) {
        int i = eyeType;
        MeshData meshData = i == 2 ? this.rightMeshData : this.leftMeshData;
        if (meshData != null) {
            ...
            float[] texMatrix = i2 == 1 ? i == 2 ? TEX_MATRIX_BOTTOM : TEX_MATRIX_TOP : i2 == 2 ? i == 2 ? TEX_MATRIX_RIGHT : TEX_MATRIX_LEFT : TEX_MATRIX_WHOLE;
