...
public final class Tx3gDecoder extends SimpleSubtitleDecoder {
    ...
    private void decodeInitializationData(List<byte[]> initializationData) {
        ...
        if (initializationData != null && initializationData.size() == 1 && (((byte[]) initializationData.get(0)).length == 48 || ((byte[]) initializationData.get(0)).length == 53)) {
            ...
            this.defaultFontFamily = TX3G_SERIF.equals(Util.fromUtf8Bytes(initializationBytes, 43, initializationBytes.length - 43)) ? C.SERIF_NAME : "sans-serif";
    ...
    private static String readSubtitleText(ParsableByteArray parsableByteArray2) throws SubtitleDecoderException {
        ...
        if (parsableByteArray2.bytesLeft() >= 2) {
            char firstChar = parsableByteArray2.peekChar();
            if (firstChar == 65279 || firstChar == 65534) {
                return parsableByteArray2.readString(textLength, Charset.forName("UTF-16"));
            }
        }
