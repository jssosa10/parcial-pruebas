...
public final class DrmInitData implements Comparator<SchemeData>, Parcelable {
    ...
    public static final class SchemeData implements Parcelable {
        ...
        public SchemeData(UUID uuid2, @Nullable String licenseServerUrl2, String mimeType2, byte[] data2, boolean requiresSecureDecryption2) {
        ...
        public SchemeData copyWithData(@Nullable byte[] data2) {
            SchemeData schemeData = new SchemeData(this.uuid, this.licenseServerUrl, this.mimeType, data2, this.requiresSecureDecryption);
            return schemeData;
        }
    ...
    public DrmInitData(List<SchemeData> schemeDatas2) {
        this(null, false, (SchemeData[]) schemeDatas2.toArray(new SchemeData[schemeDatas2.size()]));
    }
    ...
    private DrmInitData(@Nullable String schemeType2, boolean cloneSchemeDatas, SchemeData... schemeDatas2) {
        ...
        if (cloneSchemeDatas) {
            schemeDatas2 = (SchemeData[]) schemeDatas2.clone();
        }
