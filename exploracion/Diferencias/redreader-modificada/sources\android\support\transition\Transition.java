...
public abstract class Transition implements Cloneable {
                ...
                if (start == null || end == null || isTransitionRequired(start, end)) {
                    ...
                    if (animator4 != null) {
                            ...
                            if (view2 == null || properties == null) {
                                ...
                                if (properties.length > 0) {
                                    ...
                                    while (true) {
                                        ...
                                        AnimationInfo info2 = (AnimationInfo) runningAnimators.get((Animator) runningAnimators.keyAt(j2));
                                        if (info2.mValues != null && info2.mView == view2) {
                                            numExistingAnims = numExistingAnims2;
                                            if (info2.mName.equals(getName()) && info2.mValues.equals(infoValues2)) {
                                                animator2 = null;
                                                break;
                                            }
                                        } else {
                        ...
                        if (animator != null) {
                            ...
                            AnimationInfo info3 = new AnimationInfo(view, getName(), this, ViewUtils.getWindowId(sceneRoot), infoValues);
                            runningAnimators.put(animator, info3);
    ...
    public void pause(View sceneRoot) {
        if (!this.mEnded) {
            ...
            for (int i = numOldAnims - 1; i >= 0; i--) {
                AnimationInfo info2 = (AnimationInfo) runningAnimators.valueAt(i);
                if (info2.mView != null && windowId.equals(info2.mWindowId)) {
    ...
    public void forceToEnd(ViewGroup sceneRoot) {
        ...
        if (sceneRoot != null) {
            ...
            for (int i = numOldAnims - 1; i >= 0; i--) {
                AnimationInfo info2 = (AnimationInfo) runningAnimators.valueAt(i);
                if (!(info2.mView == null || windowId == null || !windowId.equals(info2.mWindowId))) {
