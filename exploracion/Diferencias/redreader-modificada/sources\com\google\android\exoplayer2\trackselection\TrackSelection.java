...
public interface TrackSelection {
    ...
    public final /* synthetic */ class CC {
        @Deprecated
        public static void $default$updateSelectedTrack(TrackSelection trackSelection, long playbackPositionUs, long bufferedDurationUs, long availableDurationUs) {
            throw new UnsupportedOperationException();
        }

        public static void $default$updateSelectedTrack(TrackSelection trackSelection, long playbackPositionUs, long bufferedDurationUs, long availableDurationUs, List list, MediaChunkIterator[] mediaChunkIterators) {
