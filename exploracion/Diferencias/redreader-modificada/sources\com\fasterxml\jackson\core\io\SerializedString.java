...
public class SerializedString implements SerializableString, Serializable {
    ...
    public final char[] asQuotedChars() {
        ...
        char[] result2 = BufferRecyclers.getJsonStringEncoder().quoteAsString(this._value);
    ...
    public final byte[] asUnquotedUTF8() {
        ...
        byte[] result2 = BufferRecyclers.getJsonStringEncoder().encodeAsUTF8(this._value);
    ...
    public final byte[] asQuotedUTF8() {
        ...
        byte[] result2 = BufferRecyclers.getJsonStringEncoder().quoteAsUTF8(this._value);
    ...
    public int appendQuotedUTF8(byte[] buffer, int offset) {
        byte[] result = this._quotedUTF8Ref;
        if (result == null) {
            result = BufferRecyclers.getJsonStringEncoder().quoteAsUTF8(this._value);
    ...
    public int appendQuoted(char[] buffer, int offset) {
        char[] result = this._quotedChars;
        if (result == null) {
            result = BufferRecyclers.getJsonStringEncoder().quoteAsString(this._value);
    ...
    public int appendUnquotedUTF8(byte[] buffer, int offset) {
        byte[] result = this._unquotedUTF8Ref;
        if (result == null) {
            result = BufferRecyclers.getJsonStringEncoder().encodeAsUTF8(this._value);
