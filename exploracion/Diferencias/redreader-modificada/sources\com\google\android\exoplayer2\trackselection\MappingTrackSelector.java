...
public abstract class MappingTrackSelector extends TrackSelector {
        ...
        public int getAdaptiveSupport(int rendererIndex, int groupIndex, int[] trackIndices) {
            ...
            while (i < trackIndices.length) {
                ...
                if (handledTrackCount == 0) {
                    ...
                    multipleMimeTypes = (!Util.areEqual(obj, sampleMimeType)) | multipleMimeTypes;
                }
    ...
    public final void onSelectionActivated(Object info2) {
        this.currentMappedTrackInfo = (MappedTrackInfo) info2;
    }
    ...
    public final TrackSelectorResult selectTracks(RendererCapabilities[] rendererCapabilities, TrackGroupArray trackGroups) throws ExoPlaybackException {
        ...
        MappedTrackInfo mappedTrackInfo = new MappedTrackInfo(iArr, trackGroupArrayArr, iArr2, iArr3, new TrackGroupArray((TrackGroup[]) Util.nullSafeArrayCopy(rendererTrackGroups[rendererCapabilitiesArr.length], rendererTrackGroupCounts[rendererCapabilitiesArr.length])));
