...
public class PeriodFormatterBuilder {
    ...
    static class Separator implements PeriodPrinter, PeriodParser {
        ...
        public int parseInto(ReadWritablePeriod readWritablePeriod, String str, int i, Locale locale) {
            ...
            int parseInto = this.iBeforeParser.parseInto(readWritablePeriod2, str2, i2, locale2);
            if (parseInto < 0) {
                return parseInto;
            }
            int i3 = 0;
            if (parseInto > i2) {
                ...
                while (true) {
                    ...
                    if (str.regionMatches(true, parseInto, str3, 0, str3.length())) {
                        break;
                    }
                    i4++;
                }
            ...
            int i5 = -1;
            int parseInto2 = this.iAfterParser.parseInto(readWritablePeriod2, str2, parseInto, locale2);
            if (parseInto2 < 0) {
                return parseInto2;
            }
            if (i3 != 0 && parseInto2 == parseInto && i5 > 0) {
                return parseInto ^ -1;
            }
            if (parseInto2 <= parseInto || i3 != 0 || this.iUseBefore) {
                return parseInto2;
            }
            return parseInto ^ -1;
        }
