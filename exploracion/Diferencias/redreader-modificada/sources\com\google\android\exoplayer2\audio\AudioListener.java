...
public interface AudioListener {
    ...
    public final /* synthetic */ class CC {
        public static void $default$onAudioSessionId(AudioListener audioListener, int audioSessionId) {
        }

        public static void $default$onAudioAttributesChanged(AudioListener audioListener, AudioAttributes audioAttributes) {
        }

        public static void $default$onVolumeChanged(AudioListener audioListener, float volume) {
        }
    }
