...
public final class SampleQueue implements TrackOutput {
    ...
    private void readEncryptionData(DecoderInputBuffer buffer, SampleExtrasHolder extrasHolder2) {
        int subsampleCount;
        int[] clearDataSizes;
        int[] encryptedDataSizes;
        DecoderInputBuffer decoderInputBuffer = buffer;
        SampleExtrasHolder sampleExtrasHolder = extrasHolder2;
        ...
        byte[] bArr2 = decoderInputBuffer.cryptoInfo.iv;
        int i2 = cryptoData.cryptoMode;
        int i3 = cryptoData.encryptedBlocks;
        int i4 = i3;
        int i5 = i2;
    ...
    private void clearAllocationNodes(AllocationNode fromNode) {
        if (fromNode.wasInitialized) {
            int i = ((int) (this.writeAllocationNode.startPosition - fromNode.startPosition)) / this.allocationLength;
            Allocation[] allocationsToRelease = new Allocation[((this.writeAllocationNode.wasInitialized ? 1 : 0) + i)];
            AllocationNode currentNode = fromNode;
            for (int i2 = 0; i2 < allocationsToRelease.length; i2++) {
                allocationsToRelease[i2] = currentNode.allocation;
