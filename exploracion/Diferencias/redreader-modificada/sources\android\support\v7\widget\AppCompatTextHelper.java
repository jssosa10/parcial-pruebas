...
class AppCompatTextHelper {
    ...
    private void applyCompoundDrawableTint(Drawable drawable, TintInfo info2) {
        if (drawable != null && info2 != null) {
            AppCompatDrawableManager.tintDrawable(drawable, info2, this.mView.getDrawableState());
        }
    }
