...
public final class AdPlaybackState {
    ...
    public static final class AdGroup {
        ...
        private static long[] copyDurationsUsWithSpaceForAdCount(long[] durationsUs2, int count2) {
            ...
            Arrays.fill(durationsUs3, oldDurationsUsCount, newDurationsUsCount, C.TIME_UNSET);
            return durationsUs3;
        }
    }
    ...
    public AdPlaybackState withAdCount(int adGroupIndex, int adCount) {
        ...
        AdPlaybackState adPlaybackState = new AdPlaybackState(this.adGroupTimesUs, adGroups2, this.adResumePositionUs, this.contentDurationUs);
    ...
    public AdPlaybackState withAdResumePositionUs(long adResumePositionUs2) {
        ...
        AdPlaybackState adPlaybackState = new AdPlaybackState(this.adGroupTimesUs, this.adGroups, adResumePositionUs2, this.contentDurationUs);
        return adPlaybackState;
    }
    ...
    public AdPlaybackState withContentDurationUs(long contentDurationUs2) {
        ...
        AdPlaybackState adPlaybackState = new AdPlaybackState(this.adGroupTimesUs, this.adGroups, this.adResumePositionUs, contentDurationUs2);
        return adPlaybackState;
    }
