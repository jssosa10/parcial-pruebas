    ...
    public static abstract class Callback {
        ...
        private class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message msg) {
                if (msg.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending((RemoteUserInfo) msg.obj);
                }
            }
        }
  ...
  mth insns count: 90
        ...
        class ExtraSession extends Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback cb) {
                if (!MediaSessionImplApi21.this.mDestroyed) {
                    ...
                    MediaSessionImplApi21.this.mExtraControllerCallbacks.register(cb, new RemoteUserInfo(packageName, getCallingPid(), getCallingUid()));
                }
            }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class MediaSessionStub extends Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback cb) {
                ...
                MediaSessionImplBase.this.mControllerCallbacks.register(cb, new RemoteUserInfo(RemoteUserInfo.LEGACY_CONTROLLER, getCallingPid(), getCallingUid()));
            }
        ...
        /* access modifiers changed from: 0000 */
        public void sendVolumeInfoChanged(ParcelableVolumeInfo info2) {
            for (int i = this.mControllerCallbacks.beginBroadcast() - 1; i >= 0; i--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(i)).onVolumeInfoChanged(info2);
                } catch (RemoteException e) {
                }
            }
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle tokenBundle) {
            ...
            Token token2 = (Token) tokenBundle.getParcelable(MediaSessionCompat.KEY_TOKEN);
            if (token2 != null) {
                token = new Token(token2.mInner, extraSession, token2Bundle);
            }
            return token;
        }
    }
