...
final class Sonic {
    ...
    public Sonic(int inputSampleRateHz2, int channelCount2, float speed2, float pitch2, int outputSampleRateHz) {
        ...
        this.minPeriod = inputSampleRateHz2 / MAXIMUM_PITCH;
    ...
    public void queueEndOfStream() {
        ...
        int expectedOutputFrames = this.outputFrameCount + ((int) ((((((float) remainingFrameCount) / (f / f2)) + ((float) this.pitchFrameCount)) / r) + 0.5f));
        ...
        while (true) {
            ...
            this.inputBuffer[(i3 * remainingFrameCount) + xSample] = 0;
            xSample++;
        }
