...
public final class Track {
    ...
    public Track(int id2, int type2, long timescale2, long movieTimescale2, long durationUs2, Format format2, int sampleTransformation2, @Nullable TrackEncryptionBox[] sampleDescriptionEncryptionBoxes2, int nalUnitLengthFieldLength2, @Nullable long[] editListDurations2, @Nullable long[] editListMediaTimes2) {
        this.id = id2;
        this.type = type2;
