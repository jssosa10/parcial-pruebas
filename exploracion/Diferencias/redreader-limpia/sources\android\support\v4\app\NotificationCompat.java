...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder setContentInfo(CharSequence info2) {
            this.mContentInfo = limitCharSequenceLength(info2);
            return this;
        }
            ...
            if (VERSION.SDK_INT >= 16) {
                ...
                for (int i = this.mMessages.size() - 1; i >= 0; i--) {
                    ...
                    if (i != this.mMessages.size() - 1) {
                        completeMessage.insert(0, StringUtils.LF);
                    }
    ...
    public static abstract class Style {
        ...
        public RemoteViews applyStandardTemplate(boolean showSmallIcon, int resId, boolean fitIn1U) {
            ...
            if (this.mBuilder.mContentInfo != null) {
                contentView.setTextViewText(R.id.f1info, this.mBuilder.mContentInfo);
                contentView.setViewVisibility(R.id.f1info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else if (this.mBuilder.mNumber > 0) {
                if (this.mBuilder.mNumber > res.getInteger(R.integer.status_bar_notification_info_maxnum)) {
                    contentView.setTextViewText(R.id.f1info, res.getString(R.string.status_bar_notification_info_overflow));
                } else {
                    contentView.setTextViewText(R.id.f1info, NumberFormat.getIntegerInstance().format((long) this.mBuilder.mNumber));
                }
                contentView.setViewVisibility(R.id.f1info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else {
                contentView.setViewVisibility(R.id.f1info, 8);
