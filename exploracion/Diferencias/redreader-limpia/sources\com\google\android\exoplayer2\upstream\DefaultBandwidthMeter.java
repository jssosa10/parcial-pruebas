...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static final class Builder {
        ...
        public Builder setEventListener(Handler eventHandler2, EventListener eventListener2) {
            Assertions.checkArgument((eventHandler2 == null || eventListener2 == null) ? false : true);
        ...
        public DefaultBandwidthMeter build() {
            ...
            DefaultBandwidthMeter bandwidthMeter = new DefaultBandwidthMeter(initialBitrateEstimate.longValue(), this.slidingWindowMaxWeight, this.clock);
            Handler handler = this.eventHandler;
            if (handler != null) {
                EventListener eventListener2 = this.eventListener;
                if (eventListener2 != null) {
                    bandwidthMeter.addEventListener(handler, eventListener2);
                }
            }
    ...
    private DefaultBandwidthMeter(long initialBitrateEstimate, int maxWeight, Clock clock2) {
    ...
    private void notifyBandwidthSample(int elapsedMs, long bytes, long bitrate) {
        ...
        $$Lambda$DefaultBandwidthMeter$0dWpVoCfeEm8PONlagOKGMu96M r1 = new Event(elapsedMs, bytes, bitrate) {
