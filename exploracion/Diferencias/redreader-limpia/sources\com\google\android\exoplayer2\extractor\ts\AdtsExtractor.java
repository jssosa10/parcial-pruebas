...
public final class AdtsExtractor implements Extractor {
    ...
    private SeekMap getConstantBitrateSeekMap(long inputLength) {
        ConstantBitrateSeekMap constantBitrateSeekMap = new ConstantBitrateSeekMap(inputLength, this.firstFramePosition, getBitrateFromFrameSize(this.averageFrameSize, this.reader.getSampleDurationUs()), this.averageFrameSize);
