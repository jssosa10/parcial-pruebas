...
public final class PsExtractor implements Extractor {
    ...
    public void seek(long position, long timeUs) {
        if ((this.timestampAdjuster.getTimestampOffsetUs() == C.TIME_UNSET) || !(this.timestampAdjuster.getFirstSampleTimestampUs() == 0 || this.timestampAdjuster.getFirstSampleTimestampUs() == timeUs)) {
    ...
    public int read(ExtractorInput input, PositionHolder seekPosition) throws IOException, InterruptedException {
        ...
        if (nextStartCode == PACK_START_CODE) {
            ...
            if (!this.foundAllTracks) {
                ...
                if (input.getPosition() > ((!this.foundAudioTrack || !this.foundVideoTrack) ? 1048576 : this.lastTrackPosition + 8192)) {
    ...
    private void maybeOutputSeekMap(long inputLength) {
        if (!this.hasOutputSeekMap) {
            ...
            if (this.durationReader.getDurationUs() != C.TIME_UNSET) {
                PsBinarySearchSeeker psBinarySearchSeeker2 = new PsBinarySearchSeeker(this.durationReader.getScrTimestampAdjuster(), this.durationReader.getDurationUs(), inputLength);
