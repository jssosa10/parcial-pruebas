...
public final class SpliceInsertCommand extends SpliceCommand {
    ...
    public static final class ComponentSplice {
        ...
        public static ComponentSplice createFromParcel(Parcel in) {
            ComponentSplice componentSplice = new ComponentSplice(in.readInt(), in.readLong(), in.readLong());
    ...
    static SpliceInsertCommand parseFromSection(ParsableByteArray sectionData, long ptsAdjustment, TimestampAdjuster timestampAdjuster) {
        ...
        long programSplicePts3 = C.TIME_UNSET;
        ...
        if (!spliceEventCancelIndicator2) {
            ...
            if (!programSpliceFlag3) {
                ...
                while (i < componentCount) {
                    ...
                    boolean spliceImmediateFlag4 = spliceImmediateFlag3;
                    ComponentSplice componentSplice = new ComponentSplice(componentTag, componentSplicePts2, timestampAdjuster2.adjustTsTimestamp(componentSplicePts2));
                    emptyList.add(componentSplice);
                    i++;
                    programSpliceFlag3 = programSpliceFlag4;
                    componentCount = componentCount2;
                    spliceImmediateFlag3 = spliceImmediateFlag4;
                }
        ...
        long j = programSplicePts2;
        SpliceInsertCommand spliceInsertCommand = new SpliceInsertCommand(spliceEventId2, spliceEventCancelIndicator2, outOfNetworkIndicator2, programSpliceFlag2, spliceImmediateFlag2, programSplicePts2, timestampAdjuster2.adjustTsTimestamp(programSplicePts2), list, autoReturn2, breakDurationUs2, uniqueProgramId2, availNum2, availsExpected2);
