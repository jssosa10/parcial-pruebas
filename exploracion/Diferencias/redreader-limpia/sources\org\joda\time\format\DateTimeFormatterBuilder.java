...
public class DateTimeFormatterBuilder {
    ...
    static class MatchingParser implements InternalParser {
        ...
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int i) {
            ...
            while (true) {
                ...
                InternalParser internalParser = internalParserArr[i4];
                if (internalParser != null) {
                    ...
                    if (parseInto >= i) {
                        if (parseInto > i2) {
                            ...
                            int i5 = i4 + 1;
                            if (i5 >= length || internalParserArr[i5] == null) {
                                break;
                            }
    ...
    static abstract class NumberFormatter implements InternalPrinter, InternalParser {
        ...
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int i) {
            ...
            int i5 = i;
            int min = Math.min(this.iMaxParsedDigits, charSequence.length() - i5);
            int i6 = 0;
            boolean z3 = false;
            boolean z4 = false;
            while (true) {
                ...
                if (i6 != 0 || ((charAt != '-' && charAt != '+') || !this.iSigned)) {
                    if (charAt < '0' || charAt > '9') {
                        break;
                    }
                    i6++;
        ...
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int i) {
            ...
            while (true) {
                if (i3 >= min) {
                    ...
                    int i4 = i3 + 1;
                    str2 = charSequence.subSequence(i, i4).toString();
                    i2 = str2.length() + i;
                    if (i3 < length) {
        ...
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int i) {
            ...
            if (this.iLenientParse) {
                ...
                if (z || i7 != 2) {
                    if (i7 >= 9) {
                        i3 = i7 + i6;
                        i4 = Integer.parseInt(charSequence.subSequence(i6, i3).toString());
                    } else {
                        if (z2) {
                            i5 = i6 + 1;
                        } else {
