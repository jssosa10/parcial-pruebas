...
public final class DefaultDataSourceFactory implements Factory {
    ...
    public DefaultDataSourceFactory(Context context2, String userAgent, @Nullable TransferListener listener2) {
        this(context2, listener2, (Factory) new DefaultHttpDataSourceFactory(userAgent, listener2));
    }

    public DefaultDataSourceFactory(Context context2, Factory baseDataSourceFactory2) {
        this(context2, (TransferListener) null, baseDataSourceFactory2);
    }

    public DefaultDataSourceFactory(Context context2, @Nullable TransferListener listener2, Factory baseDataSourceFactory2) {
