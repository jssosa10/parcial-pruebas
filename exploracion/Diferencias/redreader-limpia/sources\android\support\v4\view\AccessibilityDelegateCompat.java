...
public class AccessibilityDelegateCompat {
    ...
    private static final class AccessibilityDelegateAdapter extends AccessibilityDelegate {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfo info2) {
            this.mCompat.onInitializeAccessibilityNodeInfo(host, AccessibilityNodeInfoCompat.wrap(info2));
        }
    ...
    public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info2) {
        DEFAULT_DELEGATE.onInitializeAccessibilityNodeInfo(host, info2.unwrap());
    }
