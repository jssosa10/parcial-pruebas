...
public interface Player {
    ...
    public interface EventListener {
        ...
        public final /* synthetic */ class CC {
            public static void $default$onTimelineChanged(EventListener eventListener, @Nullable Timeline timeline, Object manifest, int reason) {
            }

            public static void $default$onTracksChanged(EventListener eventListener, TrackGroupArray trackGroups, TrackSelectionArray trackSelections) {
            }

            public static void $default$onLoadingChanged(EventListener eventListener, boolean isLoading) {
            }

            public static void $default$onPlayerStateChanged(EventListener eventListener, boolean playWhenReady, int playbackState) {
            }

            public static void $default$onRepeatModeChanged(EventListener eventListener, int repeatMode) {
            }

            public static void $default$onShuffleModeEnabledChanged(EventListener eventListener, boolean shuffleModeEnabled) {
            }

            public static void $default$onPlayerError(EventListener eventListener, ExoPlaybackException error) {
            }

            public static void $default$onPositionDiscontinuity(EventListener eventListener, int reason) {
            }
