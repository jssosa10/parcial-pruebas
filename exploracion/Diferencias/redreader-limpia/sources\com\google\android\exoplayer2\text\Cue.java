...
public class Cue {
    ...
    public Cue(CharSequence text2, Alignment textAlignment2, float line2, int lineType2, int lineAnchor2, float position2, int positionAnchor2, float size2, int textSizeType2, float textSize2) {
    ...
    public Cue(CharSequence text2, Alignment textAlignment2, float line2, int lineType2, int lineAnchor2, float position2, int positionAnchor2, float size2, boolean windowColorSet2, int windowColor2) {
    ...
    private Cue(CharSequence text2, Alignment textAlignment2, Bitmap bitmap2, float line2, int lineType2, int lineAnchor2, float position2, int positionAnchor2, int textSizeType2, float textSize2, float size2, float bitmapHeight2, boolean windowColorSet2, int windowColor2) {
        this.text = text2;
