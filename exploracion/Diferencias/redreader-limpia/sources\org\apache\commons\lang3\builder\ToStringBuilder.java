...
public class ToStringBuilder implements Builder<String> {
    ...
    public static void setDefaultStyle(ToStringStyle style2) {
        Validate.isTrue(style2 != null, "The style must not be null", new Object[0]);
        defaultStyle = style2;
    }
    ...
    public static String reflectionToString(Object object2, ToStringStyle style2, boolean outputTransients) {
        return ReflectionToStringBuilder.toString(object2, style2, outputTransients, false, null);
    }
