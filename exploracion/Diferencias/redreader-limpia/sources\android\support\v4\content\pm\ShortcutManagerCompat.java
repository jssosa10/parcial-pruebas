...
public class ShortcutManagerCompat {
    ...
    public static boolean isRequestPinShortcutSupported(@NonNull Context context) {
        ...
        for (ResolveInfo info2 : context.getPackageManager().queryBroadcastReceivers(new Intent(ACTION_INSTALL_SHORTCUT), 0)) {
            String permission = info2.activityInfo.permission;
