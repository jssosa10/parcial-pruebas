...
public interface ExoMediaDrm<T extends ExoMediaCrypto> {
    ...
    public static final class KeyRequest {
        ...
        public KeyRequest(byte[] data2, String licenseServerUrl2) {
            this.data = data2;
    ...
    public static final class KeyStatus {
        ...
        public KeyStatus(int statusCode2, byte[] keyId2) {
    ...
    public static final class ProvisionRequest {
        ...
        public ProvisionRequest(byte[] data2, String defaultUrl2) {
            this.data = data2;
