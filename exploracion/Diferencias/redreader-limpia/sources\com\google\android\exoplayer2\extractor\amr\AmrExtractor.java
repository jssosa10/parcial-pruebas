...
public final class AmrExtractor implements Extractor {
    ...
    private SeekMap getConstantBitrateSeekMap(long inputLength) {
        ConstantBitrateSeekMap constantBitrateSeekMap = new ConstantBitrateSeekMap(inputLength, this.firstSamplePosition, getBitrateFromFrameSize(this.firstSampleSize, 20000), this.firstSampleSize);
