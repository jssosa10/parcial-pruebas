...
public class AccessibilityNodeInfoCompat {
    ...
    public static class CollectionInfoCompat {
        ...
        CollectionInfoCompat(Object info2) {
            this.mInfo = info2;
        }
    ...
    public static class CollectionItemInfoCompat {
        ...
        CollectionItemInfoCompat(Object info2) {
            this.mInfo = info2;
        }
    ...
    public AccessibilityNodeInfoCompat(Object info2) {
        this.mInfo = (AccessibilityNodeInfo) info2;
    }

    private AccessibilityNodeInfoCompat(AccessibilityNodeInfo info2) {
        this.mInfo = info2;
    }

    public static AccessibilityNodeInfoCompat wrap(@NonNull AccessibilityNodeInfo info2) {
        return new AccessibilityNodeInfoCompat(info2);
    }
    ...
    public static AccessibilityNodeInfoCompat obtain(AccessibilityNodeInfoCompat info2) {
        return wrap(AccessibilityNodeInfo.obtain(info2.mInfo));
    }
    ...
    public CollectionInfoCompat getCollectionInfo() {
        if (VERSION.SDK_INT >= 19) {
            CollectionInfo info2 = this.mInfo.getCollectionInfo();
            if (info2 != null) {
    ...
    public CollectionItemInfoCompat getCollectionItemInfo() {
        if (VERSION.SDK_INT >= 19) {
            CollectionItemInfo info2 = this.mInfo.getCollectionItemInfo();
            if (info2 != null) {
    ...
    public RangeInfoCompat getRangeInfo() {
        if (VERSION.SDK_INT >= 19) {
            RangeInfo info2 = this.mInfo.getRangeInfo();
            if (info2 != null) {
