...
const QUESTIONNAIRE = [{
  ...
  choices: ['On my local machine', 'In the cloud using Experitest', 'In the cloud using Sauce Labs', 'In the cloud using Browserstack or Testingbot or a different service', 'I have my own Selenium cloud']
}, {
  type: 'input',
  name: 'hostname',
